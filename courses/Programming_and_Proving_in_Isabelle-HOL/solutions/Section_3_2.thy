...
(* NOTE: Proving some lemmata, just to be sure about a couple facts. *)
...
lemma ins_01 [simp]: "x = y \<Longrightarrow> set (ins x (Node l y r)) = {x} \<union> set (Node l y r) \<and> ord (Node l y r) \<Longrightarrow> ord (ins x (Node l y r))"
  apply auto
  done
